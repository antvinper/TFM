...
public abstract class EffectDefinition : ScriptableObject, IEffect
{
     ...
     * - El estado qu� vamos a mirar pertenece al owner o al target?
    ...
    /**
     * Si se le ha reducido la rapidez un 10% nos devolver� el valor SIN la reducci�n
     */
    ...
    /**
     * Si se le ha reducido la rapidez un 10% nos devolver� el valor CON la reducci�n
     */
