...
public class DuringTimeEffect : TimeEffectDefinition
{
    ...
    {
        //No s・por qu・valen true nada m疽 empezar
        cancel = false;
        reset = false;
        this.owner = owner;
        ...
        if (target.TryAddTemporallyState(this))
        {
             ...
             * 
             * ｿｿComo puedo saber si obtener el valor del actual o del permanente? Elecci de momento.
             */
            ...
            //Lo dejo as・por si se desea dar feedback del tiempo o algo
